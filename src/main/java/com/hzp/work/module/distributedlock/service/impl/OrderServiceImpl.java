...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    private A4_RedisLock1_NoFinally redisLock1_noFinally;
    @Autowired
    private A5_RedisLock2_OnlyFinally redisLock2_onlyFinally;
    @Autowired
    private A6_RedisLock3_AddExpire redisLock3_addExpire;
    @Autowired
    private A7_RedisLock4_AtomExpire redisLock4_atomExpire;
    @Autowired
    private A8_RedisLock5_UUID redisLock5_uuid;
    @Autowired
    private A9_RedisLock6_Redisson redisLock6_redisson;
...
//        return redisLock4_atomExpire.order(id);
        ...
        // 解决：动态设置失效时间，可以自动续长
//        return redisLock5_uuid.order(id);
        ...
        // 解决：zk
        return redisLock6_redisson.order(id);
    }
